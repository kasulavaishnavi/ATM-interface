...
class BankAccount {
    ...
    public final void clrscr() {
        try {
            try {
                final String os = System.getProperty("oc.name");
    ...
    public void transfer(double amount, BankAccount acc) {
        if (this.balance < amount) {
            clrscr();
            System.out.println("--------------------------------");
            System.out.println("Transfer fails dur to insufficient balance!");
            System.out.println("---------------------------------");
        } else{
            this.balance -= amount;
            acc.balance += amount;
        ...
        do {
            ...
            switch (option) {
                ...
                case 'E' :
                    ...
                    BankAccount bb = new BankAccount("Ram", "1002");
...
public class ATMInterface {
    public static void main(String[] args) {
        BankAccount ba = new BankAccount("Rani", "1001");
        ba.checkId();
    }
}